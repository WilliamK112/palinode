...
- **Auditable compaction.** Palinode validates structured model output and applies each change as a git commit. You can `git blame` every line in your agent's brain.
